...
| 参数名 | 类型 | 必填 | 说明 |
|--------|------|------|------|
| options | RichEditorAreaOptions | 否 | 富文本编辑组件的参数。 |
...
| snapShotController | SnapShotController | 是 | 截图控制器 |
...
| DevEcoStudio版本 | DevEco Studio 6.0.0 | DevEco Studio 6.0.1 |
|------------------|---------------------|---------------------|

## 来源

- 原始URL: https://developer.huawei.com/consumer/cn/market/prod-detail/837623efe716444a83898a19b253c5a0/2adce9bbd4cb42d58a87e6add45594b3?origin=template

## OSS 下载链接

- https://xiaobaili-0921.oss-cn-beijing.aliyuncs.com/harmony-skill-factory/components/%E5%AF%8C%E6%96%87%E6%9C%AC%E7%BC%96%E8%BE%91%E7%BB%84%E4%BB%B6/richeditor1.0.3.zip